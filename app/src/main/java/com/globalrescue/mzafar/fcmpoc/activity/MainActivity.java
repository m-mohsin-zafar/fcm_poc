package com.globalrescue.mzafar.fcmpoc.activity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayFirebaseRegId() {
        ...
        if (!TextUtils.isEmpty(regId)) {
            displayText = "Firebase Reg Id: " + regId;
            txtRegId.setText(displayText);
        }else {
            displayText = "Firebase Reg Id is not received yet!";
            txtRegId.setText(displayText);
        }
    }
